---
title: AI 配置与大模型矩阵
description: 配置 splicr 支持的 11 大 LLM 解说稿生成引擎与 3 大 TTS 人声克隆服务。
---

# 🧠 AI 配置与大模型矩阵

splicr 采用统一的 LLM & TTS Provider 架构。所有 API 密钥均通过应用内 **设置 → AI 服务** 进行本地加密存储，绝不上云或外传。
...
splicr 原生支持 `README.md` 与底层核心代码指定的 11 大大语言模型引擎：
...
splicr 提供从免费内置配音到专业人声克隆的全套解决方案，支持单独为 TTS 引擎指定 **TTS API Key** 与 **TTS Base URL**：
