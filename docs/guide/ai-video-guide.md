---
title: AI 工作流详解
description: splicr 从视频素材到第一人称解说成片的 7 步 AI 工作流详解。
---

# 🤖 AI 工作流详解

splicr 的 AI 生产流程围绕 **“剧情理解 ➔ 独白脚本 ➔ 黄金声波合成 ➔ 剪映草稿交付”** 闭环设计。每个阶段都有明确的数据产出与质量评估，确保视频解说的完播率与观感。
