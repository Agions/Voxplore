//! scenefab-video v2.5.0 · 视频编排核心 (M4.3 实装)
//!
//! ## 责任范围
...
//!   真正的 ffmpeg 拼接 / 转码由 [`scenefab-ffmpeg`] 在执行层完成
//! - 复用 [`scenefab_domain::ExportStrategy`] 枚举,避免类型重复
//! - 校验失败返回 [`VideoPlanError`],由上层转 `SceneFabError::Pipeline`
//!
//! ## 用法
//! ```
//! use scenefab_domain::ExportStrategy;
//! use scenefab_video::{build_plans, PlanOptions};
