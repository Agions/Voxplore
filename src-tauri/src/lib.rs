...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::project::project_snapshot_list,
            commands::project::project_snapshot_create,
            commands::project::project_snapshot_restore,
            commands::project::project_snapshot_delete,
