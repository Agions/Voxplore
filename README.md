...
**splicr（叙影）** 是一款基于 **Tauri 2 + Rust + React 19** 深度研发的桌面端 AI 视频叙事与解说编辑器。
...
| :---: | :---: |
| <img src="assets/splicr_dashboard_cover.png" width="460" alt="splicr 首页 Dashboard 界面截图" style="border-radius: 8px; border: 1px solid #27272A;" /> | <img src="assets/splicr_assets_cover.png" width="460" alt="splicr 素材资产管理界面截图" style="border-radius: 8px; border: 1px solid #27272A;" /> |

| 7 步全自动解说生产工作区 | 11 大模型与 TTS 设置表单 |
| :---: | :---: |
| <img src="assets/splicr_production_cover.png" width="460" alt="splicr 7 步解说生产工作区界面截图" style="border-radius: 8px; border: 1px solid #27272A;" /> | <img src="assets/splicr_settings_cover.png" width="460" alt="splicr 模型设置表单界面截图" style="border-radius: 8px; border: 1px solid #27272A;" /> |
...
├── crates/
│   ├── splicr-core       # 核心类型 (AppContext / SplicrError)
│   ├── splicr-domain     # 领域模型 (Project / Timeline / MediaFile)
│   ├── splicr-detect     # FFmpeg 探针 / 场景切分 / 音画混流
│   ├── splicr-script     # 11 大 LLM 客户端与独白脚本引擎
│   ├── splicr-voice      # Edge-TTS / OpenAI-TTS / GPT-SoVITS
│   ├── splicr-subtitle   # FFmpeg silencedetect VAD 端点检测与字幕生成
│   ├── splicr-compose    # 7 步流水线状态机与 DAG 执行器
│   ├── splicr-export     # 剪映草稿 (.draft) 生成器与平台预设
│   ├── splicr-storage    # 本地 SQLite / JSON 存储
│   └── splicr-update     # 应用自动更新引擎
└── Makefile              # 常用构建与测试指令
```
