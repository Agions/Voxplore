...
describe("VideoPlanPreview", () => {
  ...
  it("series 策略展示 episode 编号 + series_context", async () => {
    ...
    expect(screen.getAllByText("scenefab-demo").length).toBeGreaterThan(0);
  });

  it("IPC 失败 → 显示 SceneFabError 错误提示", async () => {
