...
from app.core.security_keys import SecureKeyManager


class TestSecureKeyManager:
    """测试安全密钥管理器"""

    @patch("app.core.security_keys.platform.system")
    @patch("app.core.security_keys.keyring")
    ...
    @patch("app.core.security_keys.platform.system")
    @patch("app.core.security_keys.keyring")
    @patch("app.core.security_keys.SecureKeyManager._get_master_key")
