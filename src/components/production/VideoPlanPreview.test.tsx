/**
 * splicr v1.0.0 · VideoPlanPreview 组件单测
 *
 * 验证:
...
describe("VideoPlanPreview", () => {
  ...
  it("series 策略展示 episode 编号 + series_context", async () => {
    ...
    fireEvent.change(seriesInput, { target: { value: "splicr-demo" } });
    ...
    expect(screen.getAllByText("splicr-demo").length).toBeGreaterThan(0);
  });

  it("IPC 失败 → 显示 SplicrError 错误提示", async () => {
