/**
 * splicr v1.0.0 · 全量双语 (i18n) 字典与翻译函数
 */
...
export const TRANSLATIONS: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    "action.delete": "删除工程",
    "action.start": "启动 Multi-Agent 创作团队",
    "action.stop": "暂停 / 取消智能体协同",
    "action.enter": "进入制作工作台 →",

    // 首页 Dashboard
    "home.welcome_title": "splicr 叙影 AI 视频叙事工作室",
    "home.welcome_subtitle": "打造下一部爆款电影级短剧与影视解说作品 · Rust Native 多智能体协作引擎",
    "home.recent_title": "最近视频解说工程",
    "home.see_all": "查看资产库 →",
    "home.no_project": "暂无历史解说工程",
    "home.no_project_sub": "点击下方按钮快速建立第一个 AI 短剧/影视解说工程",
    "home.create_project": "➕ 新建解说工程",
    "home.project_file_tag": "工程文件 · 本地极速处理",
    "home.pipeline_title": "Multi-Agent 智能体协作流水线",
  ...
  "en-US": {
    ...
    // Home Dashboard
    "home.welcome_title": "splicr AI Narrative Video Studio",
