...
if TYPE_CHECKING:
    from app.services.ai.scene_models import SceneInfo
    from app.services.video_understanding.models import StoryGraph
...
class NarrationContext:
    ...
    story_graph: StoryGraph = field(
        default_factory=lambda: __import__(
            "app.services.video_understanding.models", fromlist=["StoryGraph"]
        ).StoryGraph()
    )
