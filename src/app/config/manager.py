...
from app.utils.project_io import ensure_directories

from ..utils.json_io import read_json, write_json
from ..utils.version import get_version_string
from .config import ConfigManager
from .definitions import get_all_config_definitions
from .types import ConfigDefinition, ProjectSettingsProfile, SettingType
...
class ProjectSettingsManager(QObject):
    ...
    def __init__(self, config_manager: ConfigManager):
        ...
        self.settings_definitions: dict[str, ConfigDefinition] = {}
    ...
    def _init_settings_definitions(self) -> None:
        ...
        self.settings_definitions.update(get_all_config_definitions())
    ...
    def get_setting_definition(self, key: str) -> ConfigDefinition | None:
        """获取设置定义"""
        return self.settings_definitions.get(key)

    def get_all_setting_definitions(self) -> dict[str, ConfigDefinition]:
        """获取所有设置定义"""
